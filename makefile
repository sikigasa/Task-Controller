...
migrateup:
	migrate --path db/migrations --database 'postgresql://postgres:postgres@localhost:5432/task?sslmode=disable' -verbose up

migratedown:
	migrate --path db/migrations --database 'postgresql://postgres:postgres@localhost:5432/task?sslmode=disable' -verbose down
